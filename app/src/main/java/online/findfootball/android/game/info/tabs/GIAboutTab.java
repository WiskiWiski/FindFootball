...
public class GIAboutTab extends Fragment {
    ...
    private DatabaseInstance.OnLoadListener loadListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        loadListener = new DatabaseInstance.OnLoadListener() {
            @Override
    ...
    public void setData(GameObj game) {
        ...
        thisGameOwnerUser.load(loadListener);
    }
    ...
    public void onResume() {
        ...
        if (thisGameOwnerUser != null) {
            if (thisGameOwnerUser.hasLoaded()) {
                updateOwnerView();
            } else if (!thisGameOwnerUser.isLoading()) {
                showUserLoading(true);
                thisGameOwnerUser.load(loadListener);
            }
        }
